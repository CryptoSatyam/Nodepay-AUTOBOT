...
class Nodepay:
    ...
    def welcome(self):
        print(
            f"""
        {Fore.GREEN + Style.BRIGHT}Nodepay AutoMining by {Fore.BLUE + Style.BRIGHT} @CryptoSatyam1 Keep Support
            """
            f"""
        {Fore.GREEN + Style.BRIGHT} Developed by {Fore.YELLOW + Style.BRIGHT} [ SATYAM ] Don't Forget to Join - (https://t.me/CryptoSatyam1) 
            """
        )
